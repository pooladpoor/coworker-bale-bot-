...
SYSTEM_PROMPT = (
    ...
    "مهم: تمام فرمول‌های ریاضی و مهندسی را حتماً در کادرهای استاندارد لاتک قرار بده. "
    "برای فرمول‌های درون‌خطی از $...$ یا \\( ... \\) و برای فرمول‌های بزرگ و مستقل از $$...$$ یا \\\\[ ... \\\\] استفاده کن "
    "تا در صفحه وب به درستی رندر شوند."
)
...
def create_html_report(gemini_ans, gpt_ans, output_filename="answer.html"):
    ...
    <head>
        ...
        <style>
            ...
            # 🟢 کلاس استایل برای حفظ خطوط متن و زیباسازی نمایش نهایی
            .content-area {{ 
    ...
    <body>
        <div class="container">
            ...
            <div class="box gemini">
                ...
                <div class="content-area">{gemini_ans}</div>
            </div>
            <div class="box gpt">
                <h3>🧠 پاسخ مدل ChatGPT (OpenAI)</h3>
                <div class="content-area">{gpt_ans}</div>
            </div>
        </div>
    </body>
    </html>
